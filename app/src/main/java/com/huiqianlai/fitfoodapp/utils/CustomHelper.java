...
import com.huiqianlai.fitfoodapp.R;
...
public class CustomHelper {
    ...
    public void onClick(TakePhoto takePhoto,int id) {
...
//            return null;
//        }
        int height = Integer.parseInt(String.valueOf(800));
        int width = Integer.parseInt(String.valueOf(800));
