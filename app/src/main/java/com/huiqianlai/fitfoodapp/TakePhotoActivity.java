    ...
    private void startCamera() {
        ...
        findViewById(R.id.capture_button).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                File file = new File(TakePhotoActivity.this.getExternalCacheDir() + File.separator + System.currentTimeMillis() + ".png");
...
//                        Intent intent = new Intent(TakePhotoActivity.this, PrepareCropActivity.class);
